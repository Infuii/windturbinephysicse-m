import { MapPin, Users, Wind, Home, Book } from "lucide-react";
    ...
    <div className="space-y-8">
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <p className="text-gray-600">
          Somalia, covering 95 km² on the Horn of Africa, represents a land of
          rich cultural heritage and strategic importance. The country's
          position between sub-Saharan Africa and Arabia has historically made
          it a crucial trading hub, influencing its diverse cultural makeup and
          economic potential.
        </p>
      </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <ul className="list-disc list-inside text-gray-600">
              <li>
                Clan System (Qabiil): Forms the foundation of social
                organization
              </li>
              <li>Xeer: Traditional legal system based on customary law</li>
              <li>
                Council of Elders (Guurti): Community decision-making body
              </li>
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-600">
              <li>
                Poetry (Gabay): Oral tradition of storytelling and history
              </li>
          ...
          <div>
            ...
            <p className="text-gray-600">
              Islam plays a central role in daily life, influencing: - Prayer
              times and community gatherings - Charitable giving (Zakat) -
              Social responsibilities - Educational practices
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center space-x-2 mb-4">
          ...
          <h2 className="text-xl font-semibold">
            Cultural Integration of Wind Energy
          </h2>
        </div>
        <div className="space-y-4">
          <div>
          ...
          <div>
            ...
            <p className="text-gray-600">
              Combining traditional knowledge with modern technology: - Training
              programs in local language - Incorporation of traditional
              problem-solving methods - Respect for existing social hierarchies
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Creating opportunities for the next generation: - Technical
              education - Digital connectivity - Modern skill development -
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-gray-600">
              Combining traditional weather reading methods with modern wind
              forecasting: - Local wind pattern knowledge - Seasonal climate
              understanding - Traditional navigation techniques - Environmental
              indicators
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600">
              Integrating traditional conservation methods: - Land use
              management - Resource preservation - Environmental stewardship -
