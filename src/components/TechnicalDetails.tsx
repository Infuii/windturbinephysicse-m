    ...
    <div className="space-y-8">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-gray-600">
              The turbine utilizes Faraday's law of electromagnetic induction
              where the rate of change of magnetic flux through a conductor
              induces an electromotive force. In our design, permanent magnets
              mounted on the rotating turbine blades pass by stationary copper
              coils, generating electrical current.
            </p>
          </div>
          <div>
            <h3 className="font-medium text-gray-900">Generator Design</h3>
            <p className="text-gray-600">
              Our generator employs a three-phase AC design with: - Neodymium
              permanent magnets (N52 grade) - Copper wire coils (AWG 14) -
              Optimized air gap of 1.5mm - 12 pole pairs for maximum efficiency
            </p>
          </div>
          <div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center space-x-2 mb-4">
          ...
          <h2 className="text-xl font-semibold">
            Performance in Somali Conditions
          </h2>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-600">
              We provide comprehensive training to local technicians, focusing
              on: - Basic troubleshooting - Preventive maintenance - Safety
              procedures - Emergency repairs
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-gray-600">
              The system includes: - Grid-tie inverters - Smart metering - Load
              management systems - Backup power capabilities
            </p>
          </div>
          <div>
            <h3 className="font-medium text-gray-900">Storage Solutions</h3>
            <p className="text-gray-600">
              Hybrid storage system combining: - Lithium-ion batteries -
              Mechanical flywheel storage - Smart charge controllers
            </p>
          </div>
          <div>
            <h3 className="font-medium text-gray-900">Community Impact</h3>
            <p className="text-gray-600">
              Benefits include: - Job creation for maintenance and operations -
              Reduced energy costs - Improved energy reliability - Environmental
              benefits
            </p>
          </div>
        </div>
