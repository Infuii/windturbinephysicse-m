...
const powerData = [
  { windSpeed: 5.7, theoretical: 3.5617, actual: 3.4 },
  { windSpeed: 6.09, theoretical: 4.344, actual: 4.2 },
  { windSpeed: 6.19, theoretical: 4.5615, actual: 4.4 },
];
...
function Charts() {
  return (
    <div className="space-y-8">
        ...
        <div className="h-[400px]">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={powerData}>
              ...
              <XAxis
                dataKey="windSpeed"
                label={{ value: "Wind Speed (m/s)", position: "bottom" }}
              />
              <YAxis
                label={{
                  value: "Power (W)",
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <h3 className="text-lg font-semibold mb-4">
          Energy Production vs Local Demand
        </h3>
        <div className="h-[400px]">
          <ResponsiveContainer width="100%" height="100%">
